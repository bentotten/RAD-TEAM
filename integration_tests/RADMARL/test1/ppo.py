...
def update(
    ...
    ac.model.train()
    loss_mod = update_model(data, args, loss=optimization.MSELoss)
    ...
    return pi_l, loss_v, loss_mod, kl, ent, cf, loc_loss, 0, kk
...
if __name__ == '__main__':
    ...
    ppo(lambda : gym.make(args.env,**init_dims), actor_critic=core.RNNModelActorCritic,
        ...
        logger_kwargs=logger_kwargs,render=False, save_gif=False, load_model=args.load_model, number_of_agents=agents)
