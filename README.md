...
1. [RECOMMENDED] For multi-threaded processing, it is highly highly recommended that you install MPI [[link](https://www.open-mpi.org/)].

1.1. `sudo apt install openmpi-bin openmpi-doc libopenmpi-dev`
