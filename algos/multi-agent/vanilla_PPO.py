...
class PPO:
    def __init__(self, state_dim, action_dim, lr_actor, lr_critic, gamma, K_epochs, eps_clip, grid_bounds, has_continuous_action_space=False, action_std_init=0.6, resolution_accuracy=None):
    ...
    def set_action_std(self, new_action_std):
        if self.has_continuous_action_space:
            ...
            self.policy.set_action_std(new_action_std)  # Actor-critic
            self.policy_old.set_action_std(new_action_std)  # Actor-critic
        else:
            print("--------------------------------------------------------------------------------------------")
