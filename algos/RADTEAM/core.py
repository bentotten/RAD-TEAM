...
class PFRNNBaseCell(nn.Module):
    ...
    def __init__(self, num_particles, input_size, hidden_size, resamp_alpha, use_resampling, activation):
        """init function
...
class PFGRUCell(PFRNNBaseCell):
    def __init__(self, num_particles, input_size, obs_size, hidden_size, resamp_alpha, use_resampling, activation):
        super().__init__(num_particles, input_size, hidden_size, resamp_alpha, use_resampling, activation)
