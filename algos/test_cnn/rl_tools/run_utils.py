...
from rl_tools.mpi_tools import mpi_fork, msg
...
def setup_logger_kwargs(exp_name, seed=None, data_dir='../exp', datestamp=False,env_name=None):
    """
    ...
    logger_kwargs = dict(output_dir=osp.join(data_dir, relpath), 
                         exp_name=exp_name)
    #if not os.path.exists(logger_kwargs['output_dir']+'/gifs'):
    #    os.makedirs(logger_kwargs['output_dir']+'/gifs') 
