        ...
        if np.any(data[0][elem][1]['TotEpLen'] == mc_ep_len):
            ...
            if control == 'rid-fim':
                ...
                try:
                    ...
                    print(f'{control} threw an error')   
