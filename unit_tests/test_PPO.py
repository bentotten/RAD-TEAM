...
class RADA2C:
    ...
    def get_hiddens():
        return {0: ((
            torch.Tensor([[0.5960, 0.1294, 0.2328, 0.9597, 0.8043, 0.4710, 0.5223, 0.6586, 0.2308, 0.6779, 0.1494, 0.1594, 0.4553, 0.6984, 0.9075,
                            0.1983, 0.0502, 0.6131, 0.0998, 0.5853, 0.1522, 0.4587, 0.7399, 0.8631],
                [0.4578, 0.4242, 0.9543, 0.5092, 0.2156, 0.0329, 0.1127, 0.9901, 0.4490, 0.0687, 0.9534, 0.9364, 0.2560, 0.0931, 0.6246, 0.5947,
                            0.4765, 0.1815, 0.6810, 0.5026, 0.5180, 0.0270, 0.1005, 0.6143],
                [0.6932, 0.0314, 0.3692, 0.9569, 0.2258, 0.0847, 0.5165, 0.3565, 0.7375, 0.6349, 0.5715, 0.0441, 0.8497, 0.6552, 0.7374, 0.3136,
                            0.2569, 0.5107, 0.0480, 0.0807, 0.9456, 0.8801, 0.9488, 0.5441],
                [0.9551, 0.7699, 0.9073, 0.3029, 0.9872, 0.9591, 0.9568, 0.8517, 0.5288, 0.5498, 0.5092, 0.2473, 0.5126, 0.8796, 0.2021, 0.2906,
                            0.6036, 0.0222, 0.0740, 0.3175, 0.7116, 0.0065, 0.8193, 0.1974],
